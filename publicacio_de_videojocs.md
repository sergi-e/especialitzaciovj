...
> - [Xbox One](#xbox-one)
> - [Game Pass](#game-pass)
5. [Publicació amb Unity i Unreal Engine](#5-publicació-amb-unity-i-unreal-engine)
...
## 5 Publicació amb Unity i Unreal Engine
  Els avantatges i inconvenients de cadascun d'aquests motors són temes complexes i per l'elecció d'un o altre cal tenir en compte molts factors. Per parlar del que ocupa aquesta publicació. Els termes i condicions de les llicències són molt importants i cal llegir-los i comprendre-los en la seua totalitat, ja que certs detalls moltes vegades passem per damunt detalls de gran repercusió. 
  - La publicació amb Unity és gratuïta mentre els beneficis no superen els 100.000$. En aplegar a cert benefici cal pagar una llicència per cada membre desenvolupador de l'equip.
  - El desenvolupament en Unreal Engine implica el pagament de royalties: un 5% a partir de 1 milió USD de beneficis, [quedant aquest primer milió exempt de royalties](#https://www.unrealengine.com/en-US/faq). Els royalties es calculen en base als beneficis totals del joc, és a dir, contant també el marge de beneficis que pugui tener una distribuidora com GOG, Steam o Epic.
